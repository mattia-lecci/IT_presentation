...
% try to avoid inline equation to be broken in different lines
\relpenalty=10000
\binoppenalty=10000
...
\newcommand{\vh}[1]{\ensuremath{\hat{\vb{#1}}}}
...
\input{tex/deterministic_H.tex}
\input{tex/ergodic_H.tex}
\input{tex/multi_user.tex}
